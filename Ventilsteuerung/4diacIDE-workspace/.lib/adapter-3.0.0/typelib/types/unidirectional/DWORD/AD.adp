...
<AdapterType Name="AD" Comment="unidirectional Adapter Interface for 1 Event and 1 Dword">
	...
	<InterfaceList>
		...
		<OutputVars>
			<VarDeclaration Name="D1" Type="DWORD" Comment="Indication (or Request) Data from Plug"/>
		</OutputVars>
	</InterfaceList>
