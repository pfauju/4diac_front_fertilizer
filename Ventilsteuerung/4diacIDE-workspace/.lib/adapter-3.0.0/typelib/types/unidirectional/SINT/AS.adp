...
<AdapterType Name="AS" Comment="unidirectional Adapter Interface for 1 Event and 1 Sint">
	...
	<InterfaceList>
		...
		<OutputVars>
			<VarDeclaration Name="D1" Type="SINT" Comment="Indication (or Request) Data from Plug"/>
		</OutputVars>
	</InterfaceList>
