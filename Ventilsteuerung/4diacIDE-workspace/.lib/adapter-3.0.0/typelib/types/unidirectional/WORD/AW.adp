...
<AdapterType Name="AW" Comment="unidirectional Adapter Interface for 1 Event and 1 Word">
	...
	<InterfaceList>
		...
		<OutputVars>
			<VarDeclaration Name="D1" Type="WORD" Comment="Indication (or Request) Data from Plug"/>
		</OutputVars>
	</InterfaceList>
