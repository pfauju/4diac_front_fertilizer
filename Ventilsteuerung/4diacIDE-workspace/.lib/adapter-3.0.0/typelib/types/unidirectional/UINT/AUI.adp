...
<AdapterType Name="AUI" Comment="unidirectional Adapter Interface for 1 Event and 1 Uint">
	...
	<InterfaceList>
		...
		<OutputVars>
			<VarDeclaration Name="D1" Type="UINT" Comment="Indication (or Request) Data from Plug"/>
		</OutputVars>
	</InterfaceList>
