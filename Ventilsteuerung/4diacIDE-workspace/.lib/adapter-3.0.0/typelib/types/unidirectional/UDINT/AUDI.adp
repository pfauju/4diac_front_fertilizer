...
<AdapterType Name="AUDI" Comment="unidirectional Adapter Interface for 1 Event and 1 Udint">
	...
	<InterfaceList>
		...
		<OutputVars>
			<VarDeclaration Name="D1" Type="UDINT" Comment="Indication (or Request) Data from Plug"/>
		</OutputVars>
	</InterfaceList>
