...
<AdapterType Name="ADI" Comment="unidirectional Adapter Interface for 1 Event and 1 Dint">
	...
	<InterfaceList>
		...
		<OutputVars>
			<VarDeclaration Name="D1" Type="DINT" Comment="Indication (or Request) Data from Plug"/>
		</OutputVars>
	</InterfaceList>
