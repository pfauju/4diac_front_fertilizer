...
<AdapterType Name="ALI" Comment="unidirectional Adapter Interface for 1 Event and 1 Lint">
	...
	<InterfaceList>
		...
		<OutputVars>
			<VarDeclaration Name="D1" Type="LINT" Comment="Indication (or Request) Data from Plug"/>
		</OutputVars>
	</InterfaceList>
