...
<AdapterType Name="AR" Comment="unidirectional Adapter Interface for 1 Event and 1 Real">
	...
	<InterfaceList>
		...
		<OutputVars>
			<VarDeclaration Name="D1" Type="REAL" Comment="Indication (or Request) Data from Plug"/>
		</OutputVars>
	</InterfaceList>
