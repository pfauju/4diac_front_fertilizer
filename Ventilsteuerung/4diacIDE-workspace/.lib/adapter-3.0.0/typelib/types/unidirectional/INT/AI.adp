...
<AdapterType Name="AI" Comment="unidirectional Adapter Interface for 1 Event and 1 Int">
	...
	<InterfaceList>
		...
		<OutputVars>
			<VarDeclaration Name="D1" Type="INT" Comment="Indication (or Request) Data from Plug"/>
		</OutputVars>
	</InterfaceList>
