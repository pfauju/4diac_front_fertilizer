...
<AdapterType Name="AUS" Comment="unidirectional Adapter Interface for 1 Event and 1 Usint">
	...
	<InterfaceList>
		...
		<OutputVars>
			<VarDeclaration Name="D1" Type="USINT" Comment="Indication (or Request) Data from Plug"/>
		</OutputVars>
	</InterfaceList>
